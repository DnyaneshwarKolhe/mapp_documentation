...
- Here are all the UI components in one on one
  ...
  - **Schedule 1:1** *button*: This button will open form to schedule one-on-one. We'll discuss this in detail in an upcoming chapter.
  ...
  - **Quick links**: This contains multiple links as follows: Action Items of previous 1:1, Agenda for next 1:1, Prepare for next 1:1, 1:1 Effectiveness, Learn more about 1:1s
    - Out of these, only 1:1 Effectiveness is active. Rest all links are coming soon.
#### Schedule 1:1
...
- The form has the following things
  ...
  - **Series**: It's a toggle and when you enable it, you can see a dropdown to select Recurrence.
    ...
    - On this popup, you need to select start date, end date, and repeat every, which depends on the option you selected from recurrence, like 
      ...
      - In case you selected custom, it's the same as day, where you can select between day, date, or month.
...
- **This week/Today**: 
  ...
  - This edit button is visible to only the creator of the meeting, using which you can edit the occurrence or the series(if it is part of a series meeting)
...
- At the end of the page, you have two buttons
  ...
  - **I'm done**: Finish the meeting, once clicked you can see confirmation popup and after that there is one more popup which says that you have completed 1:1 successfully and asks if you want to schedule next 1:1
